...
sys.path.append(r'c:\users\ionut\pycharmprojects\ki\venv\lib\site-packages\models')
sys.path.append(r'c:\users\ionut\pycharmprojects\ki\venv\lib\site-packages\models\slim')
